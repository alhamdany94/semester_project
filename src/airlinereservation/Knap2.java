...
class Knap2 implements ActionListener {
    UdenlandskeRejser type;
    LoginFelt type1;

    Knap2(UdenlandskeRejser var1, LoginFelt var2) {
        this.type = var1;
        this.type1 = var2;
    }
    ...
    public void actionPerformed(ActionEvent var1) {
        ...
        if (var4.equals("Economic")) {
            try {
                while(var11 < 20) {
                    if (this.type1.row2[var11][1].equals(var3)) {
                        var6 = Integer.parseInt((String)this.type1.row2[var11][2]);
                        var7 = (String)this.type1.row2[var11][3];
                        break;
                    }
            ...
            try {
                while(var11 < 20) {
                    if (this.type1.row2[var11][1].equals(var3)) {
                        var6 = Integer.parseInt((String)this.type1.row4[var11][2]);
                        var7 = (String)this.type1.row4[var11][3];
                        break;
                    }
        ...
        try {
            ObjectInputStream var24 = new ObjectInputStream(new FileInputStream("save1"));

            Save1 var23;
            do {
                var23 = (Save1)var24.readObject();
        ...
        if (var13 > 60) {
            ...
            if (var31 == 0) {
                new PrintBillet(var2, var3, var4, var8, var9, var10, var5, var6, var7);

                try {
                    Save1 var32 = new Save1(var2, var3, var4, var8, var9, var10, var5, var6, var7);
                    ObjectOutputStream var25 = new ObjectOutputStream(new FileOutputStream("save1"));

                    for(var11 = 0; var11 < var12; ++var11) {
                        Save1 var26 = new Save1(var14[var11], var15[var11], var16[var11], var19[var11], var20[var11], var21[var11], var17[var11], var22[var11], var18[var11]);
