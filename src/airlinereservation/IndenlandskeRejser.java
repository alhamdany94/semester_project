...
public class IndenlandskeRejser extends JFrame {
    JComboBox CBFrom;
    JComboBox CBTo;
    JComboBox CBClass;
    JComboBox CBAdult;
    ...
    public IndenlandskeRejser(LoginFelt var1) {
        Container var2 = this.getContentPane();
        var2.setLayout(new BorderLayout());
        String[] var3 = new String[]{"Trivandrum"};
        String[] var4 = new String[]{"Bangalore", "Chennai ", "Delhi", "Goa", "Hyderabad", "Kolkata", "Lucknow", "Mumbai", "Vishakapatnam"};
        ...
        this.BFindFlight.addActionListener(new Knap3(this, var1));
    }

    public static void main(String[] var0) {
        Object var1 = null;
        new IndenlandskeRejser((LoginFelt)var1);
    }
}
